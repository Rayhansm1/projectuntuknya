...
if(jawaban && jawaban.length < 19){
  ...
  await swals.fire('Makasih🥰', 'Terimakasih atas jawabannya :)', 'success');
  window.location = "https://rayhansm1.github.io/bungaflower2/";
  tombol();
} else {
  await swals.fire('Ups!', 'Jangan Di Kosongin Dong :(');jawab();
}
}